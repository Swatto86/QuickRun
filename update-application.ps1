<#
.SYNOPSIS
    QuickRun Release Script - Creates versioned releases with proper Git tagging.

.DESCRIPTION
    This script automates the release process:
    1. Validates semantic version format (x.y.z)
    2. Updates version in Cargo.toml, tauri.conf.json, and package.json
...
.EXAMPLE
    .\update-application.ps1 -Version "1.0.0" -Notes "Initial release"

.EXAMPLE
    .\update-application.ps1 -Version "1.0.1" -Notes "Bug fixes" -Force
    # Overwrites existing v1.0.1 release
...
Write-ColorOutput "           QuickRun Release Script                         " "Cyan"
...
git add $CargoTomlPath $TauriConfPath $PackageJsonPath
...
Write-ColorOutput "  https://github.com/Swatto86/QuickRun/actions" "Cyan"
Write-Host ""
